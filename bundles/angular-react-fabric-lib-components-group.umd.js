    ...
    ***************************************************************************** */
    ...
    var GroupItemDirective = /** @class */ (function (_super) {
        ...
        GroupItemDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'fab-group-item' },] }
        ];
        GroupItemDirective.propDecorators = {
            groupItemsDirectives: [{ type: core.ContentChildren, args: [GroupItemDirective,] }],
            ...
            isShowingAll: [{ type: core.Input }],
            isDropEnabled: [{ type: core.Input }],
            data: [{ type: core.Input }],
            ariaLabel: [{ type: core.Input }],
            hasMoreData: [{ type: core.Input }],
...
//# sourceMappingURL=angular-react-fabric-lib-components-group.umd.js.map
